module "aws_create_sp" {
  ...
  service_principal_name       = "mlops-db-aws-cicd"
  project_directory_path       = "/yashps/mlops-db-aws"
  service_principal_group_name = "mlops-db-aws-service-principals"
}
...
provider "databricks" {
  alias = "staging_sp"
  host  = "https://adb-6585838103436245.5.azuredatabricks.net"
